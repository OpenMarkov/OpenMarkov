...
public abstract class NetworkEvaluationInferenceTest {
	...
	protected abstract ProbNet loadNetwork(String networkName) throws ProbNetParserException, URISyntaxException, IOException;
