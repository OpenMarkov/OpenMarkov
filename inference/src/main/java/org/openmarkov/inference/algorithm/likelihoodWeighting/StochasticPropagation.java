...
public abstract class StochasticPropagation extends InferenceAlgorithm implements Propagation {
    ...
    StochasticPropagation(ProbNet probNet) throws NotEvaluableNetworkException.NotApplicableNetwork, ConstraintViolatedException {
        super(probNet);
     ...
     */
    protected abstract double[] getValuesSampledAndWeight() throws NonProjectablePotentialException, ThereIsNoPotentialInNodeException;
     ...
     */
    @Override
    public HashMap<Variable, TablePotential> getPosteriorValues() throws IncompatibleEvidenceException.EvidenceIsIncompatibleWithOther, IncompatibleEvidenceException.SamplesWeightIsZero, NonProjectablePotentialException, ThereIsNoPotentialInNodeException {
