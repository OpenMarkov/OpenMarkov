...
public abstract class VariableElimination extends InferenceAlgorithm {
	 ...
	 */
	public VariableElimination(ProbNet network) throws NotEvaluableNetworkException.NotApplicableNetwork, ConstraintViolatedException {
		super(network);
        
        setHeuristicFactory((probNet, variables) -> new RolloutElimination(probNet, variables));
	}
