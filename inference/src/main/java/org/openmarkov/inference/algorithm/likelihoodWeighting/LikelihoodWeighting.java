...
public class LikelihoodWeighting extends StochasticPropagation {
    ...
    public LikelihoodWeighting(ProbNet probNet) throws NotEvaluableNetworkException.NotApplicableNetwork, ConstraintViolatedException {
        super(probNet);
    }
    
    @Override
    protected double[] getValuesSampledAndWeight() throws NonProjectablePotentialException, ThereIsNoPotentialInNodeException {
