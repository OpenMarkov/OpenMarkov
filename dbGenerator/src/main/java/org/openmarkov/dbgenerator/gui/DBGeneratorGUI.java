...
public class DBGeneratorGUI extends JDialog {
    ...
    private JComboBox<String> caseNumber;
    ...
    private void initComponents() {
        ...
        jPanel2 = new JPanel();
        caseNumber = new JComboBox<String>(CASES_VALUES);
        ...
        jPanel8.setBorder(
                BorderFactory.createTitledBorder(stringDatabase.getString("DBGenerator.ChooseNet")));
        ...
        jPanel2.setBorder(
                BorderFactory.createTitledBorder(stringDatabase.getString("DBGenerator.NumberOfCases")));
