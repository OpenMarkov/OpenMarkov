In OpenMarkov, tests are written using [JUnit5](https://junit.org/junit5/), which you can use
through OpenMarkov's
pom.xml if your project is a child of OpenMarkov, or you can get it as specified
[here](https://mvnrepository.com/artifact/org.junit.jupiter/junit-jupiter-api) in the Maven
Repository.
