...
> Objetivo: identificar qué pruebas hay que escribir antes de modificar código para evitar
> regresiones.
...
- `getPotentials(NodeType)` con todos los valores de `NodeType` (CHANCE, DECISION, UTILITY,
  SV_PRODUCT, SV_SUM).
