...
public class PiecewiseExponentialPanel
    ...
    public PiecewiseExponentialPanel(Node node) {
        ...
        initValueCheck.addActionListener(actionEvent -> {
                                             if (initValueCheck.isSelected())
    ...
    public boolean saveChanges() throws DoEditException, BinomialPotentialWrongValueException.ThetaValueIsWrong, BinomialPotentialWrongValueException.NValuesIsWrong {
        ...
        for (int i = 0; i < piecewiseExponentialTablePanel.valuesTable.getRowCount(); i++) {
            treeMapTable.put(Double.parseDouble(piecewiseExponentialTablePanel.valuesTable.getValueAt(i, 1, null)
                                                                                          .toString()),
                             Double.parseDouble(piecewiseExponentialTablePanel.valuesTable.getValueAt(i, 2, null)
                                                                                          .toString()));
        }
