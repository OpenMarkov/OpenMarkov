...
//	}
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if (actionCommand.equals(ActionCommands.ADD_FUNCTION.getCommandName())) {
            String functionString = valuesTableWithEvents.getValueAt(selectedRow, selectedColumn, e.getSource())
                                                         .toString();
            ArithmeticExpressionDialog expressionDialog = new ArithmeticExpressionDialog(null, functionParameters, functionString);
            expressionDialog.setVisible(true);
